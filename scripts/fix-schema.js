...
const createStatements = [
  ...
  "CREATE TABLE \"EMPLOYEE\" (\"id\" NUMBER DEFAULT EMPLOYEE_ID_SEQ.NEXTVAL PRIMARY KEY, \"name\" VARCHAR2(50) NOT NULL, \"username\" VARCHAR2(50) NOT NULL, \"password_hash\" VARCHAR2(200) NOT NULL, \"role\" VARCHAR2(20) DEFAULT 'USER' NOT NULL, \"department_id\" NUMBER, \"email\" VARCHAR2(100), \"position\" VARCHAR2(50), \"created_at\" TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, \"updated_at\" TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, \"deleted_at\" TIMESTAMP, CONSTRAINT \"FK_EMPLOYEE_DEPARTMENT\" FOREIGN KEY (\"department_id\") REFERENCES \"DEPARTMENT\"(\"id\") ON DELETE RESTRICT, CONSTRAINT \"UQ_EMPLOYEE_USERNAME\" UNIQUE (\"username\"))",
  ...
  "CREATE TABLE \"CUSTOMER\" (\"id\" NUMBER DEFAULT CUSTOMER_ID_SEQ.NEXTVAL PRIMARY KEY, \"name\" VARCHAR2(100) NOT NULL UNIQUE, \"category\" VARCHAR2(20) NOT NULL, \"created_at\" TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, \"updated_at\" TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, \"deleted_at\" TIMESTAMP, CONSTRAINT \"UQ_CUSTOMER_NAME\" UNIQUE (\"name\"))",
