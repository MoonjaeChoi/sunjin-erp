...
const createStatements = [
  ...
  "CREATE TABLE \"TECH_SUPPORT\" (\"id\" NUMBER DEFAULT TECH_SUPPORT_ID_SEQ.NEXTVAL PRIMARY KEY, \"title\" VARCHAR2(200) NOT NULL, \"description\" CLOB, \"support_date\" DATE NOT NULL, \"start_time\" NUMBER, \"end_time\" NUMBER, \"support_type\" VARCHAR2(20) NOT NULL, \"support_method\" VARCHAR2(20), \"status\" VARCHAR2(20) DEFAULT 'RECEIVED' NOT NULL, \"employee_id\" NUMBER NOT NULL, \"customer_id\" NUMBER NOT NULL, \"attachment_path\" VARCHAR2(500), \"attachment_name\" VARCHAR2(200), \"completed_at\" TIMESTAMP, \"created_at\" TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, \"updated_at\" TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, \"deleted_at\" TIMESTAMP, CONSTRAINT \"FK_TECH_SUPPORT_CUSTOMER\" FOREIGN KEY (\"customer_id\") REFERENCES \"CUSTOMER\"(\"id\"), CONSTRAINT \"FK_TECH_SUPPORT_EMPLOYEE\" FOREIGN KEY (\"employee_id\") REFERENCES \"EMPLOYEE\"(\"id\"), CONSTRAINT \"CHK_TS_START_TIME\" CHECK (\"start_time\" IS NULL OR (\"start_time\" >= 0 AND \"start_time\" <= 1439)), CONSTRAINT \"CHK_TS_END_TIME\" CHECK (\"end_time\" IS NULL OR (\"end_time\" >= 0 AND \"end_time\" <= 1439)), CONSTRAINT \"CHK_TS_TIME_ORDER\" CHECK ((\"start_time\" IS NULL OR \"end_time\" IS NULL) OR \"start_time\" < \"end_time\"))",
