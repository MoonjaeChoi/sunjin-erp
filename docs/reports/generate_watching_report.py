...
"""
Generate the watching church management system PDF report.
"""
...
OUTPUT_PATH = '/Users/memmem/git/sunjin-erp/docs/reports/watching_system_report.pdf'
...
def build_cover(story, styles):
    ...
    story.append(Paragraph('watching', styles['cover_subtitle']))
...
def build_pdf():
    doc = SimpleDocTemplate(
        ...
        topMargin=MARGIN,
        bottomMargin=MARGIN,
        title='watching 교회 관리 시스템 주요 기능 화면 소개 보고서',
        author='watching',
